...
namespace shopapp.data.Concrete.EfCore
{
    public static class SeedDatabase
    {
        ...
        private static Workshop[] Workshops = {
            new Workshop(){wName="Masa1",wUrl="samsung-s1",wDescription="iyi telefon1",wImageUrl="1.jpg", wIsApproved=true,wIsHome=true},
            new Workshop(){wName="Masa2",wUrl="samsung-s2",wDescription="iyi telefon2",wImageUrl="2.jpg", wIsApproved=true,wIsHome=true},
            new Workshop(){wName="Masa3",wUrl="samsung-s3",wDescription="iyi telefon3",wImageUrl="3.jpg", wIsApproved=true,wIsHome=true},
            new Workshop(){wName="Masa4",wUrl="samsung-s4",wDescription="iyi telefon4",wImageUrl="4.jpg", wIsApproved=true,wIsHome=true},
            new Workshop(){wName="Masa5",wUrl="samsung-s5",wDescription="iyi telefon5",wImageUrl="5.jpg", wIsApproved=true,wIsHome=true},
        };
